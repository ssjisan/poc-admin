...
export default function UpdateExerciseVideoForm() {
  ...
  const loadVideo = async () => {
    try {
      const { data } = await axios.get(`/exercise-video/${params.slug}`);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(`/exercise-video/${params.slug}`, formData, {
        headers: {
