...
import RemoveExerciseVideo from "../../RemoveExerciseVideo/RemoveExerciseVideo";
import ExerciseVideoPlay from "../../ExerciseVideoPlay/ExerciseVideoPlay";
...
export default function TableViewer() {
  ...
  const onDragEnd = async (result) => {
    ...
    try {
      await axios.post("/update-exercise-video-order", { reorderedVideos });
  ...
  const removeVideo = async (slug) => {
    ...
    try {
      ...
      await axios.delete(`/exercise-video/${slug}`);
  ...
  const redirectEdit = (e, selectedAlbum) => {
    navigate(`/exercise_video/${selectedAlbum.slug}`);
  };
  ...
  return (
    ...
    >
      ...
      <ExerciseVideoPlay videoOpen={videoOpen} handleVideoClose={handleVideoClose} source={selectedVideo?.url}/>
      <RemoveExerciseVideo
